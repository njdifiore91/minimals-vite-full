# Variables for the MCA Application Processing System - Staging Environment

variable "aws_region" {
  description = "The AWS region to deploy the staging infrastructure"
  type        = string
...
variable "s3_force_destroy" {
  ...
  type        = bool
  default     = true  # Default to true for staging to allow easier cleanup
}
